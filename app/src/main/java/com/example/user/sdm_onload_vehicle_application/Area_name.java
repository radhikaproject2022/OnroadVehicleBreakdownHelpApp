...
public class Area_name extends AppCompatActivity
{
...
String string_input;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.area_name);

        sharedPrefHandler=new SharedPrefHandler(this);
        string_input=sharedPrefHandler.getSharedPreferences("city");
        spinner_city=(Spinner)findViewById(R.id.area_name_area_name);
        button_submit=(Button)findViewById(R.id.area_name_search);
        ...
        button_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                Intent intent=new Intent(getApplication(), Garage_shop_list.class);
    ...
    private void getProducts(final String string_input) {
        ...
        Call<List<Garage>> call = api.getAreaName(string_input);
