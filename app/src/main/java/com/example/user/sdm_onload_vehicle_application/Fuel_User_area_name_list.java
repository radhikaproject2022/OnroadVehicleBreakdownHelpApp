...
public class Fuel_User_area_name_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fuel__user_area_name_list);
        ...
        listView_shop_list=(ListView)findViewById(R.id.loundry_shop_list_garagef);
        inputSearch = (EditText) findViewById(R.id.search_garagef);
        ...
        listView_shop_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                Intent intent=new Intent(getApplication(),Fuel_proble_details.class);
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                Fuel_User_area_name_list.this.adapter.getFilter().filter(cs);
            }
    ...
    private void getProducts(final String string_input, final String string_input1)
    {
        ...
        Call<List<Fuel_enquiry>> call = api.Fuel_user_address(string_input, string_input1);
