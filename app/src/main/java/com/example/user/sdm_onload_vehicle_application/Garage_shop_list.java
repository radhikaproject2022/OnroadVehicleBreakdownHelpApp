...
public class Garage_shop_list extends AppCompatActivity
{
...
List<Garage> productList;
 ...
 String string_input,string_input1;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.garage_shop_list);
        ...
        listView_shop_list=(ListView)findViewById(R.id.loundry_shop_list);
        ...
        listView_shop_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                Intent intent=new Intent(getApplication(),Shop_details.class);
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                Garage_shop_list.this.adapter.getFilter().filter(cs);
            }
    ...
    private void getProducts(final String string_input, final String string_input1)
    {
        ...
        Call<List<Garage>> call = api.getShopName(string_input,string_input1);
